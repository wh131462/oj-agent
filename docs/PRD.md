...
| **M2** 主流扩展 | 接入官方 API 与页面解析方案 | Codeforces + 洛谷 | 4 平台支持 | ✅ 已完成 |
| **M3** 补全与打磨 | 补齐剩余平台，完善配置与体验，处理 vsce 在 Monorepo 下打包 workspace 依赖 | POJ + 蓝桥云课 | 6 平台 + 发布到 VSCode Marketplace + npm | ✅ 适配器与发布流水线已落地，待真发布 |
